              ...
              <div className="card" style={{width: "18rem"}}>
                <img id="profPic" className="card-img-top" src={this.state.user.profilePic} alt="profile Pic"/>
                  <div className="card-body">
                      ...
                      <br/>
                      <a href="/api/user/logout" className="btn btn-danger btn-block">Log Out</a>
                    </div>
              </div>
          </div>
      );
      ...
      return (
          <div className="container">
            <br/>
              ...
              <div className="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                <div className="btn-group mr-2" role="group" aria-label="First group">
                  <Link to="/client/user/signup" className='btn btn-primary btn-lg'>SIGN UP</Link>
                  <Link to="/client/user/signin" className='btn btn-primary btn-lg'>LOG IN</Link>
                </div>
              </div>
          </div>
      );
